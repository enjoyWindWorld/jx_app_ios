...
@implementation SPCityGroupCell
...
- (UILabel *) noDataLabel
{
    if (_noDataLabel == nil) {
        ...
        [_noDataLabel setTextColor:[UIColor colorWithHexString:@"333333"]];
        [_noDataLabel setFont:[UIFont systemFontOfSize:15.0]];
    }
    return _noDataLabel;
}
...
- (void) setCityArray:(NSArray *)cityArray
{
    ...
    for (int i = 0; i < cityArray.count; i ++) {
        SPCityModel *city = [cityArray objectAtIndex:i];
        UIButton *button = nil;
...
{
    SPCityModel *city = [self.cityArray objectAtIndex:sender.tag];
