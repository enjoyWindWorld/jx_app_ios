...
- (void)setUp{
    ...
    closeButton.right = topView.right-15;
    
    closeButton.centerY = topView.height*0.5;
...
//    frame.origin.y = maskView.bounds.size.height - self.frame.size.height+60;
    ...
    [UIView animateWithDuration:0.3 delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
        ...
        [maskView.layer setTransform:[weakself firstTransform]];

    } completion:^(BOOL finished) {
        
        [UIView animateWithDuration:0.3 delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
            
            [maskView.layer setTransform:[weakself secondTransform]];
...
-(void)disMiss{
    ...
    [UIView animateWithDuration:0.3 delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
        ...
        //同时进行 感觉更丝滑
        [mskView.layer setTransform:[weakself firstTransform]];
        ...
        [UIView animateWithDuration:0.3 delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
            //变为初始值
            [mskView.layer setTransform:CATransform3DIdentity];
...
- (CATransform3D)secondTransform{
    ...
    //向上移
    t2 = CATransform3DTranslate(t2, 0, mskView.frame.size.height * (-0.08), 0);
    //第二次缩小
