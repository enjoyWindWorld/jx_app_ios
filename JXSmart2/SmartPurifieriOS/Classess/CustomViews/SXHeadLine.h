...
typedef void(^lastBlock)(NSInteger index);

typedef void(^animateBlock)(NSInteger index);
...
@property (nonatomic,assign) BOOL isOpenTouch ;

@property (nonatomic,copy) lastBlock  lastBlock ;

@property (nonatomic,copy) animateBlock  animateBlock ;
