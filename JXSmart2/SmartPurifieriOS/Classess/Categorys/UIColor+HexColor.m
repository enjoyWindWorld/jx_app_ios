...
+ (UIColor *)colorWithRGB:(CGFloat)R G:(CGFloat)G B:(CGFloat)B {
    ...
    return [[self class] colorWithRed:R/255.0 green:G/255.0 blue:B/255.0 alpha:1];
}

+ (UIColor *)colorWithRGB:(CGFloat)R G:(CGFloat)G B:(CGFloat)B alpha:(CGFloat)alpha{

     return [[self class] colorWithRed:R/255.0 green:G/255.0 blue:B/255.0 alpha:alpha];
}
