...
###################工程信息以及最下面的蒲公英信息########################
#工程名
PROJECTNAME="SmartPurifieriOS"
#需要编译的 targetName
TARGET_NAME="SmartPurifieriOS"
# ADHOC
#证书名#描述文件
ADHOCCODE_SIGN_IDENTITY="iPhone Distribution: Shenzhen Qianhai Jingxi Intelligent Technology Co., Ltd. (36UYA9VS54)"
ADHOCPROVISIONING_PROFILE_NAME="1332e35a-a22c-494d-9423-463681d8a989"
