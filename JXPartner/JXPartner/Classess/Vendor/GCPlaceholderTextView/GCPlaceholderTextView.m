...
#define PLACECOLOR [UIColor colorWithRGB:201 G:201 B:207]
...
- (void)awakeFromNib {
    ...
    self.realTextColor = [UIColor colorWithHexString:@"333333"];
}
...
- (void) setTextColor:(UIColor *)textColor {
    if ([self.realText isEqualToString:self.placeholder]) {
        if ([textColor isEqual:PLACECOLOR]) [super setTextColor:textColor];
