...
//    float badgeHeight =(BADGE_TOTAL_OFFSET + numberSize.height);
//    float badgeWidth = MAX(badgeHeight, BADGE_TOTAL_OFFSET + numberSize.width);
//    [self setBounds:CGRectMake(0, 0, badgeWidth*0.6, badgeHeight*0.6)];
    [self setBounds:CGRectMake(0, 0, badgeWidth*0.8, badgeHeight*0.8)];
}
