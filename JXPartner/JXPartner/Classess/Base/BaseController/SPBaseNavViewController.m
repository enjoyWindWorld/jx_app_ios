...
- (void)setupNavigationBarTheme
{
    ...
    //设置导航视图上的背景色
    [[UINavigationBar appearance] setBarTintColor:[UIColor colorWithHexString:@"B70017"]];
...
//    [[UIBarButtonItem appearance] setBackButtonTitlePositionAdjustment:UIOffsetMake(0, -60) forBarMetrics:UIBarMetricsDefault];
    ...
    [[UIBarButtonItem appearance] setTitleTextAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17.f],NSForegroundColorAttributeName:[UIColor whiteColor]}
